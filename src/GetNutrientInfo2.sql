...
select food.description as 'Food', food_nutrient.amount as 'Sodium', food_portion.portion_description, food_portion.gram_weight
FROM food
JOIN food_nutrient ON food_nutrient.fdc_id = food.fdc_id
JOIN nutrient ON food_nutrient.nutrient_id = nutrient.id
JOIN food_portion ON food_portion.fdc_id = food.fdc_id 
...
select food.description as 'Food', food_nutrient.amount as 'Calories', food_portion.portion_description, food_portion.gram_weight
FROM food
JOIN food_nutrient ON food_nutrient.fdc_id = food.fdc_id
JOIN nutrient ON food_nutrient.nutrient_id = nutrient.id
JOIN food_portion ON food_portion.fdc_id = food.fdc_id 
WHERE food.description like 'cake%' AND nutrient.name = 'Energy' AND food_portion.portion_description IS NOT NULL AND food_portion.portion_description!='Quantity not specified'
 ...
 select food.description as 'Food', food_nutrient.amount as 'Calories', food_nutrient.amount as 'Sodium',  food_portion.portion_description, food_portion.gram_weight
FROM food
JOIN food_nutrient ON food_nutrient.fdc_id = food.fdc_id
JOIN nutrient ON food_nutrient.nutrient_id = nutrient.id
JOIN food_portion ON food_portion.fdc_id = food.fdc_id 
WHERE food.description like 'cake%' AND 'Calories' = 'Energy' AND 'Sodium'='Sodium, Na' AND food_portion.portion_description IS NOT NULL AND food_portion.portion_description!='Quantity not specified'
